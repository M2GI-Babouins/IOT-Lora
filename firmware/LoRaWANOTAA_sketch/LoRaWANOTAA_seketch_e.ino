...
#define FRAME_DELAY 1000 // 300000  // in ms. Every 5 minutes by default.
...
// AppKey and AppEUI.
const char appKey[] = "00FF444CD570737BC9544FFA5F6B8C12";
...
{
  Serial.begin(9600);
  Serial.println(String("-- LoRaWAN OTAA sketch --"));
  ...
  String str = "Device EUI: "; // 4ab0971d37f917bc
